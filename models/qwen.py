# qwen.py
# Runs all experiments for the Qwen 2.5 3B model.
...
# Ollama model tag for Qwen 2.5 3B Q4_K_M quantised
...
RESULTS_FILE = os.path.join(RESULTS_DIR, "qwen_results.json")
...
def run_query(prompt):
    # Sends a prompt to the Qwen model via Ollama and records
