# tinyllama.py
# Runs all experiments for the TinyLlama 1.1B model.
...
# Ollama model tag for TinyLlama 1.1B Q4 quantised
...
RESULTS_FILE = os.path.join(RESULTS_DIR, "tinyllama_results.json")
...
def run_query(prompt):
    # Sends a prompt to the TinyLlama model via Ollama and records
